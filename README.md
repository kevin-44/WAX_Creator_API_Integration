...
There are many companies you can register a [domain](https://en.wikipedia.org/wiki/Domain_name) with. [NameCheap](https://www.namecheap.com) & [GoDaddy](https://www.godaddy.com) are excellent domain name providers, and both have an active support team! Either one is highly recommended.

Before you go ahead and purchase a domain, decide whether you want an [SSL Certificate](https://en.wikipedia.org/wiki/Public_key_certificate) or not since purchasing one after you register a domain is often more expensive (or you must pay the full price as no discount will be applied)! An SSL certificate will encrypt your visitors' information, thus improving the security of your website - it is recommended that you install one!
